...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('/models/{id}/update', [BrandController::class, 'updateModel'])->name('models.update');
        Route::delete('/models/{id}/delete', [BrandController::class, 'deleteModel'])->name('models.delete');
        
        Route::get('/families/{id}/edit', [BrandController::class, 'editFamily'])->name('families.edit');
        Route::post('/families/{id}/update', [BrandController::class, 'updateFamily'])->name('families.update');
        Route::delete('/families/{id}/delete', [BrandController::class, 'deleteFamily'])->name('families.delete');
        
        // Chassis CRUD routes
        Route::get('/chassis/{id}/edit', [BrandController::class, 'editChassis'])->name('chassis.edit');
        Route::post('/chassis/{id}/update', [BrandController::class, 'updateChassis'])->name('chassis.update');
        Route::delete('/chassis/{id}/delete', [BrandController::class, 'deleteChassis'])->name('chassis.delete');
...
Route::middleware(['auth', 'XSS'])->group(function () {
    ...
    Route::get('chassis-orders/{id}', [ChassisOrderController::class, 'show'])->name('chassis-orders.show');
    Route::put('chassis-orders/{id}', [ChassisOrderController::class, 'update'])->name('chassis-orders.update');
    Route::delete('chassis-orders/{id}', [ChassisOrderController::class, 'destroy'])->name('chassis-orders.destroy');
