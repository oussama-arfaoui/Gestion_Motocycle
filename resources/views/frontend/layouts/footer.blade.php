        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <ul class="social-links">
                    <li><a target="_blank" rel="noreferrer" href="{{ $social_facebook_link }}"><svg
                    ...
                    <li><a target="_blank" rel="noreferrer" href="{{ $social_instagram_link }}"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                                <path
                    ...
                    <li>
                        <a target="_blank" rel="noreferrer" href="{{ $social_tiktok_link }}"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;">
                                <path
                    ...
                    <li>
                        <a target="_blank" rel="noreferrer" href="{{ $social_linkedin_link }}"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <li><a target="_blank" rel="noreferrer" href="{{ $social_youtube_link }}">
