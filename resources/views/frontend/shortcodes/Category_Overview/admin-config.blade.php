...
<section class="shortcode-editor">
    ...
    <div class="node-input">
        <label class="control-label">Category Title 1</label>
        <input name="category_title_1" value="" />
    </div>
    ...
    <div class="node-input">
        <label class="control-label">Category Title 2</label>
        <input name="category_title_2" value="" />
    </div>
