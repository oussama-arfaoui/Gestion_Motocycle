...
<section class="about_extension_style1 global_container">

    <div class="about_extension_style1-text">
        <h2>{{ $title }}</h2>
        <p>{{ $description }}</p>
    </div>


    <div class="about_extension_style1-nodes">

        <div class="about_extension_style1-nodes-node">
