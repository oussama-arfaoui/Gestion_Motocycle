<section class="about_overview_style4 global_container">
    ...
    <div class="about_overview_style4-content">
        ...
        <div class="about_overview_style4-content-text">
            <div class="about_overview_style4-content-text-tag">
            ...
            <h2 class="about_overview_style4-content-text-title">{{$title}}</h2>
            <h3 class="about_overview_style4-content-text-subtitle">{{$subtitle}}</h3>
            <p class="about_overview_style4-content-text-description">{{$description}}</p>
            <div class="about_overview_style4-content-text-actions">
