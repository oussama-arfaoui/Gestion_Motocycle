        ...
        @if($category->id == $categoryId)
            <section class="category_with_examples_style1 global_container">
                ...
                <div class="category_with_examples_style1-button">
                    <x-primary_button path='/product-categories/{{ $category->id }}' text='{{ $category->category_name }}'></x-primary_button>
                </div>
                    ...
                    <div class="category_with_examples_style1-items">
                        ...
                        @foreach($products as $product)
                            <div class="category_with_examples_style1-items-item">
                                ...
                                <x-primary_button path="{{ route('products.show', $product->id) }}" text="View Product"></x-primary_button>
                            </div>
                        @endforeach
                    </div>
