        ...
        <section class="project_details_style1-hero">
            <div class="project_details_style1-hero-image-container">
                <div id="zoom-container">
                    <img id="zoom-image" src="{{ asset('storage/Images/general/' . json_decode($project->images)[0]) }}" alt="Thumbnail 1" class="project_details_style1-hero-image-container-image">
                </div>
                ...
                <div class="project_details_style1-hero-thumbnails">
                    ...
                    @foreach(json_decode($project->images) as $image)
                        <img src="{{ asset('storage/Images/general/' . $image) }}" alt="Thumbnail" class="project_details_style1-hero-thumbnails-item">
                    @endforeach
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const largeImage = document.querySelector('.project_details_style1-hero-image-container-image');
        const thumbnails = document.querySelectorAll('.project_details_style1-hero-thumbnails-item');

        const prevBtn = document.querySelector('.project_details_style1-hero-prev-btn');
        const nextBtn = document.querySelector('.project_details_style1-hero-next-btn');
