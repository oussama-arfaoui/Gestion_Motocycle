...
@section('action-btn')
    ...
    @if (Auth::user()->type == 'super admin')
            ...
            <div class="pr-2 action-btn-wrapper">
                <a class="btn btn-sm btn-icon  btn-primary me-2 text-white" data-url="{{ route('plans.create') }}" data-title="{{ __('Create New Plan') }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('Create') }}">
