...
<div class="dashboard-main-container">
    ...
    <form id="stylesForm" action="{{ route('pagesstyle.updateAll') }}" method="POST">
        ...
        <div id="stylesContainer">
            ...
            <div class="attribute">
                <input type="text" name="styles[{{ $pagesstyle->id }}][name]" placeholder="Attribute Name" class="form-control" value="{{ $pagesstyle->name }}">
                <select name="styles[{{ $pagesstyle->id }}][style]" class="form-control">
                    <option value="style1" {{ $pagesstyle->style == 'style1' ? 'selected' : '' }}>Style 1</option>
                    <option value="style2" {{ $pagesstyle->style == 'style2' ? 'selected' : '' }}>Style 2</option>
                    <option value="style3" {{ $pagesstyle->style == 'style3' ? 'selected' : '' }}>Style 3</option>
        ...
        <button type="button" id="addAttribute" class="btn btn-primary mt-3">Add Style</button>
