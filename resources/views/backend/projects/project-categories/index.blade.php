...
<div class="dashboard-main-container">
    ...
    <div class="dashboard-main-container-actions">
        {{-- Main Button --}}
        <a class="dashboard-main-button" href="{{ route('projects-categories.create') }}">
            <x-add-icon />
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="dashboard_main-table-actions">
                    ...
                    <a href="{{ route('projects-categories.edit', $category->id) }}">
                        <button class="dashboard-icon-button action-edit">
                            <x-edit-icon />
                        </button>
                    </a>

                    <form action="{{ route('projects-categories.destroy', $category->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
